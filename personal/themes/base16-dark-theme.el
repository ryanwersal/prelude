...
(let ((base00 "#151515")
  ...
  (custom-theme-set-faces
   ...
   `(helm-bookmark-file ((t (:foreground ,base0D))))
   `(helm-bookmark-gnus ((t (:foreground ,base0E))))
   `(helm-bookmark-info ((t (:foreground ,base0C))))
   `(helm-bookmark-man ((t (:foreground ,base0B))))
   `(helm-bookmark-w3m ((t (:foreground ,base0A))))
   `(helm-buffer-directory ((t (:foreground ,base06 :background ,base0D))))
   `(helm-buffer-not-saved ((t (:foreground ,base08))))
   `(helm-buffer-process ((t (:foreground ,base0F))))
   `(helm-buffer-saved-out ((t (:foreground ,base08))))
   `(helm-buffer-size ((t (:foreground ,base0E))))
   `(helm-candidate-number ((t (:foreground ,base0B))))
   `(helm-ff-directory ((t (:foreground ,base0E))))
   `(helm-ff-executable ((t (:foreground ,base0C))))
   `(helm-ff-file ((t (:foreground ,base0B))))
   `(helm-ff-invalid-symlink ((t (:foreground ,base06 :background ,base08))))
   `(helm-ff-prefix ((t (:foreground ,base00 :background ,base0A))))
   `(helm-ff-symlink ((t (:foreground ,base09))))
   `(helm-grep-cmd-line ((t (:foreground ,base0B))))
   `(helm-grep-file ((t (:foreground ,base0E))))
   `(helm-grep-finish ((t (:foreground ,base0C))))
...
(provide-theme 'base16-dark)

;;; base16-dark-theme.el ends here
